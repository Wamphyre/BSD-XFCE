...
pkg install -y gimp shotcut eq10q-lv2 drumkv1-lv2 avldrums-lv2 dragonfly-reverb artyfx-lv2 fatfrog-lv2 invada-studio-plugins-lv2 ardour lmms audacity guitarix drumgizmo yoshimi hydrogen
echo ""
